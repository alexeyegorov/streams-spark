...
public class Constants {
    ...
    public static final String NUM_WORKERS = "copies";
    public static final String UUID_ATTRIBUTE = "stream.spark.uuid";
    public static final String APPLICATION_ID = "application.id";
    public static final String SPARK_BATCH_INTERVAL = "spark-batch-interval";
